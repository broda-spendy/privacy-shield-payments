...
mod test {
    ...
    fn transfer_to_new_recipient_creates_their_account() {
        ...
        confidential_transfer(&env, alice, bob.clone(), mock_proof(&env, 500)).unwrap();
    ...
    fn transfer_fails_with_invalid_proof() {
        ...
        let result = confidential_transfer(&env, alice, bob, mock_proof(&env, 0));
    ...
    fn transfer_fails_when_sender_has_no_account() {
        ...
        let result = confidential_transfer(&env, alice, bob, mock_proof(&env, 100));
